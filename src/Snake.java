...
//-----------------------------------------------------------------------------
/**
 * This class creates a linkedlist which will contain the point coordinates of 
 * the snakes current location. This class also contains the methods to draw 
 * the snake onto the canvas and spawn the snake at the default location. 
 * @author Matt Ashford
 */
//-----------------------------------------------------------------------------
public class Snake
{
    ...
    public void drawSnake( Graphics g )
    {
        ...
        for ( Point p : snake )
        {
            g.fillRect( p.x * Globals.POINT_WIDTH, p.y * Globals.POINT_HEIGHT, 
                        Globals.POINT_WIDTH, Globals.POINT_HEIGHT );
        }
